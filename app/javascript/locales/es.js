export default {
  message: {
    ...
    froggoTeams: {
      ...
      myTeams: 'Mis Equipos',
      numberOfTeamsInOrganization: '{numberOfTeams} equipos en {organizationLogin}',
      notBelongedTeams: 'Equipos a los que no perteneces',
      numberOfMembers: '{membersLength} miembros',
