export default {
  message: {
    ...
    froggoTeams: {
      newTeam: 'New Team',
      myTeams: 'My Teams',
      numberOfTeamsInOrganization: '{numberOfTeams} teams in {organizationLogin}',
      notBelongedTeams: "Teams which you don't belong",
      numberOfMembers: '{membersLength} members',
      cleanSelection: 'Clean selecction',
