class ContributionRanker::RankContributions <
  ...
  def perform
    @amount_of_users = infer_amount_of_users
    validate_users_contributions!
    rank(with_self_contributions_first).first(@limit)
  end
  ...
  def validate_users_contributions!
  ...
  def with_self_contributions_first
    sorted_users_contributions = {}
